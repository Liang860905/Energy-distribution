...
st.markdown("比較不同溫度、低限能下動能分布及大於低限能的分子數差異。")
...
ax1.set_ylabel('機率密度', fontsize=8)
...
ax2.text(0.55, 0.85, f'大於低限能的分子比例 (模擬): {exceed_ratio_sim_2:.2f}%', 
         transform=ax2.transAxes, fontsize=8,
         bbox=dict(facecolor='white', alpha=0.8, edgecolor='none', pad=3))
ax2.text(0.55, 0.75, f'大於低限能的分子比例 (理論): {exceed_ratio_theory_2:.2f}%', 
         transform=ax2.transAxes, fontsize=8,
         bbox=dict(facecolor='white', alpha=0.8, edgecolor='none', pad=3))
ax2.set_xlabel('動能 (J)', fontsize=8)
ax2.set_ylabel('機率密度', fontsize=8)
